...
{
	/// <summary>
	/// Output parameters for the <see cref="LobbyInterface.PromoteMember" /> function.
	/// </summary>
	public struct PromoteMemberCallbackInfo : ICallbackInfo
	{
		...
		/// <summary>
		/// Context that was passed into <see cref="LobbyInterface.PromoteMember" />
		/// </summary>
	...
	internal struct PromoteMemberCallbackInfoInternal : ICallbackInfoInternal, IGettable<PromoteMemberCallbackInfo>, ISettable<PromoteMemberCallbackInfo>, System.IDisposable
	{
		...
		{
			output = new PromoteMemberCallbackInfo();
			output.Set(ref this);
		}
	}
}