...
a sample of the lobby interface can be found in the EOS_LobbyManager script.
...
Users can create a lobby by chosing a BucketID, and chosing any options they want and clicking "Create Lobby" Other users can then search of that lobby.
This is done using the search options on the right side, and any results will be listed below. 
Once in a lobby if it is enabled users will be able to talk over voice chat and individually silence others or themself, and the lobby owner can promote or kick users. 