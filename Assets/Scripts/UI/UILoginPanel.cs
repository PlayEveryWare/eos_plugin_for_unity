...
namespace PlayEveryWare.EpicOnlineServices.Samples
{
    ...
    {
        [Tooltip("Optional GameObject that implements the ILoginNavigation")]
        public GameObject outsideNavigationObject;
        ...
        private ILoginNavigation loginNavigation = null;

        private void Awake()
        {
            if (outsideNavigationObject != null)
            {
                loginNavigation = outsideNavigationObject.GetComponent<ILoginNavigation>();
            }
        ...
        private void ConfigureUIForDevAuthLogin()
        {
            ...
            loginTypeDropdown.navigation = new Navigation()
            {
                ...
                selectOnUp = loginNavigation?.GetSelectOnUpObject(),
        ...
        private void ConfigureUIForAccountPortalLogin()
        {
            ...
            loginNavigation?.ConfigureUIForLogin();
        }
        ...
        private void ConfigureUIForLogout()
        {
            ...
            loginNavigation?.ConfigureUIForLogout();
        }
