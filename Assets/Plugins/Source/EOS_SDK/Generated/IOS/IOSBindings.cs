...
namespace Epic.OnlineServices
{
	public static class IOSBindings
	{
		...
		internal delegate void EOS_Auth_LoginDelegate(System.IntPtr handle, ref Auth.IOSLoginOptionsInternal options, System.IntPtr clientData, Auth.OnLoginCallbackInternal completionDelegate);
		internal static EOS_Auth_LoginDelegate EOS_Auth_Login;
#endif

#if !EOS_DYNAMIC_BINDINGS
		[DllImport(Config.LibraryName)]
		internal static extern void EOS_Auth_Login(System.IntPtr handle, ref Auth.IOSLoginOptionsInternal options, System.IntPtr clientData, Auth.OnLoginCallbackInternal completionDelegate);
#endif
	}
}