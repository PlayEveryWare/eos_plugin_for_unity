...
1. Turn on Hyper-V. Hit the windows key and type in "Turn windows features on or off."
    ...
    > [!NOTE] The follow screenshots are taken in Windows 11, so if you are running Windows 10 yours might look a little differently.

    <img src="/docs/images/hyperv_linux_guest_vm/windows-features-search.png" width="472" />

2. Make sure you select all of the options below.

    <img src="/docs/images/hyperv_linux_guest_vm/windows-features-on-off.png" width="532" />
    ...
    <img src="/docs/images/hyperv_linux_guest_vm/task-manager-virtualization-check.png" width="948" />
...
Finally, move on to the [instructions](/docs/dev_env/Ubuntu_Development_Environment.md) to setup Ubuntu.