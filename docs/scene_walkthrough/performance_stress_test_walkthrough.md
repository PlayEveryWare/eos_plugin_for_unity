...
> [!NOTE] 
> Upon import, the `com.unity.postprocessing` package that this scene requires will be automatically installed.  You will still need to [add it in the build settings](/README.md#importing-samples).