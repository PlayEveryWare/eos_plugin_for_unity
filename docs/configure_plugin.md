...
> [!NOTE]
The included [samples](http://github.com/PlayEveryWare/eos_plugin_for_unity/README.md#samples) already have configuration values set for you to experiment with!
